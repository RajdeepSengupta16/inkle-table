  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      cell: info => {
        ...
        const text = isNaN(d) ? (raw || "N/A") : d.toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" });
    ...
    },
    {
      ...
      header: "",
      cell: ({ row }) => (
        <button onClick={() => onEdit(row.original)} className="text-gray-400 hover:text-[var(--primary)] transition-colors p-1">
          <Edit2 size={18} />
        </button>
      )
    }
